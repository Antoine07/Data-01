...
1. Créez le tableau des fréquences cumulées pour la couleur des yeux. Arrondissez à deux décimales les valeurs. Quelle est le type de la variable "Couleur des yeux" ?
